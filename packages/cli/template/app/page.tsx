    ...
    <main>
      ...
      {featured.length > 0 && (
        <section className="max-w-6xl mx-auto px-4 sm:px-6 py-20">
          <div className="flex items-end justify-between mb-10">
            ...
            <Link href="/store" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">
              View all →
            </Link>
          </div>
      ...
      <section className="bg-white border-y border-gray-100 py-20 px-4">
        <div className="max-w-md mx-auto text-center">
          ...
          <p className="text-sm text-gray-500 mb-8">Get notified about new arrivals and exclusive offers.</p>
          <TheDropClient />
        </div>
      </section>
      ...
      <footer className="border-t border-gray-100 py-10 px-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          ...
          <div className="flex gap-6">
            <Link href="/store" className="text-xs text-gray-400 hover:text-gray-700 transition-colors">Shop</Link>
            {waNumber && (
              <a href={`https://wa.me/${waNumber}`} className="text-xs text-gray-400 hover:text-gray-700 transition-colors" target="_blank" rel="noopener">
                WhatsApp
              </a>
            )}
          </div>
